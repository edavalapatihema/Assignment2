    ...
    class Program
    {
        ...
        */
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                ...
                // First pass to handle non-zero elements
        ...
        */
        ...
        public static IList<IList<int>> ThreeSum(int[] nums)
        {
            try
            {
                ...
                Array.Sort(nums); // Sort the array to easily skip duplicates
        ...
        */
        ...
        public static int FindMaxConsecutiveOnes(int[] nums)
        {
            ...
            {
                // Write your code here and you can modify the return value according to the requirements
                int maxCount = 0; // Maximum number of consecutive ones
                int currentCount = 0; // Current count of consecutive ones
        ...
        */
        ...
        public static int BinaryToDecimal(int binary)
        {
            try
            {
                // Write your code here and you can modify the return value according to the requirements
                int result = 0;
                int position = 0; // Represents the position of the current digit

                while (binary > 0)
                {
                    int digit = binary % 10; // Extract the last digit
                    result += digit * (int)Math.Pow(2, position); // Multiply the digit by 2 raised to the power of its position
        ...
        */
        ...
        public static int LargestPerimeter(int[] nums)
        {
            try
            {
                ...
                // Start from the end of the sorted array and check if a triangle can be formed
                for (int i = nums.Length - 1; i >= 2; i--)
                {
                    if (nums[i - 2] + nums[i - 1] > nums[i]) // Condition for triangle inequality
                    {
                        return nums[i - 2] + nums[i - 1] + nums[i]; // Return the perimeter of the triangle
                    }
                }

                return 0; // Return 0 if it's impossible to form a triangle
            }
        ...
        */
        ...
        public static string RemoveOccurrences(string s, string part)
        {
            try
            {
                ...
                {
                    s = s.Remove(index, part.Length); // Remove the substring part from s
                }
                return s;
            }
